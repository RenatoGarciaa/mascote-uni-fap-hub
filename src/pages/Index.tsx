...
const Index = () => {
  ...
  return <div className="min-h-screen bg-cover bg-center bg-no-repeat relative overflow-hidden" style={{
    backgroundImage: `url(/lovable-uploads/11770723-1def-4494-86a7-9a17699cfbe0.png)`
      ...
      <section className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 md:px-8">
        <div className="text-center max-w-4xl mx-auto animate-bounce-in">
          ...
          {/* CTA Button */}
          <Button onClick={scrollToForm} className="bg-gradient-warm hover:bg-gradient-vibrant text-white font-retro text-lg md:text-xl px-8 md:px-12 py-4 md:py-6 rounded-full shadow-glow transition-all duration-300 hover:scale-110 hover:shadow-xl animate-slide-up">
            🎨 Quero Participar!
          </Button>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl md:text-2xl text-white/90 font-modern max-w-3xl mx-auto">
              ...
              <span className="text-unifap-cyan font-semibold"> nosso novo mascote</span> e 
          ...
          <div className="bg-black/20 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-white/10">
            <div className="aspect-video rounded-xl overflow-hidden">
              <iframe width="100%" height="100%" src="https://www.youtube.com/embed/C9Yn_1ZZ7Lg" title="UniFAP - Criando Identidade Visual" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen className="w-full h-full"></iframe>
            </div>
